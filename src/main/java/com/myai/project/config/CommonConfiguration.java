package com.myai.project.config;

import com.myai.project.constants.SystemConstants;
import com.myai.project.model.AlibabaOpenAiChatModel;
import com.myai.project.tools.CourseTools;
...
public class CommonConfiguration {
    ...
    public ChatClient chatClient(AlibabaOpenAiChatModel model, ChatMemory chatMemory) {
        return ChatClient
                ...
                .defaultSystem("你是一个热心、可爱的智能助手，你的名字叫小天，请以小团团的身份和语气回答问题")
                .defaultAdvisors(
    ...
    public ChatClient pdfChatClient(OpenAiChatModel model, ChatMemory chatMemory, VectorStore vectorStore) {
        return ChatClient
                .builder(model)
                .defaultSystem("请根据上下文回答问题，遇到上下文没有的问题，不要随意编造答案")
                .defaultAdvisors(
                        new SimpleLoggerAdvisor(),
                        new MessageChatMemoryAdvisor(chatMemory),
